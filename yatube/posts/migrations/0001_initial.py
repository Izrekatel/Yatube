# Generated by Django 2.2.16 on 2021-09-14 08:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='Designates whether the user can log into this adminsite.', verbose_name='staff status')),
            ...
            managers=[
                ('objects', posts.models.CustomAccountManager()),
            ],
        ),
        migrations.CreateModel(
            name='Group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(help_text='Пост, к которому написан комментарий', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='posts.Post', verbose_name='Пост')),
            ],
            options={
                'ordering': ['-created'],
            },
